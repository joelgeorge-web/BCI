...
with open(csv_file_path, 'w', newline='', encoding='utf-8') as csv_file:
    ...
    csv_writer.writerow(["Time", "analogValue1"])
    ...
    try:
        while True:
            ...
            if len(data_parts) == 2:
                ...
                print(f"Stopwatch Time: {elapsed_time} ms, Analog Value 1: {analog_value_1}")

                # Write the data to the CSV file
                csv_writer.writerow([elapsed_time, analog_value_1])
